...
import { getUserByField } from "@/lib/auth/user";
...
const formSchemaLogin = z.object({
    username: z.string().min(10, {
        ...
        message: "Логін має бути не більше 10 символів.",
    }),
...
const LoginPage = () => {
    ...
    async function onSubmit(
        ...
        if (user === null) {
            ...
            await login(user);
            showToast("Ви успішно увійшли!", `Вітаємо, ${user.name}!`,
                "Гаразд", false, "/");
                ...
                <CardContent className="p-8">
                    ...
                    <Tabs defaultValue="phone">
                        <TabsList className="grid w-full grid-cols-2">
                            <TabsTrigger value="phone">Номер</TabsTrigger>
